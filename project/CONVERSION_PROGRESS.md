...
- [x] pinned_instructor_reply_revised -> app/(dashboard)/student/lessons/pinned-reply/page.tsx
- [x] desktop_secure_exam_view -> app/(dashboard)/exam/secure-desktop/page.tsx
- [x] mobile_secure_exam_view -> app/(dashboard)/exam/secure-mobile/page.tsx
...
5. Reference URL map after a conversion:
   ...
   - `/admin/dashboard`
   - `/student/lessons/pinned-reply`
   - `/exam/secure-desktop`, `/exam/secure-mobile`
